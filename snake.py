...
SNAKE = "red"
FOOD = "green"
HEAD = "blue" # Define the color for the snake's head
BACKGROUND = "#000000"
    ...
    def __init__(self): 
        ...
        for index, (x, y) in enumerate(self.coordinates): 
            if index == 0:
                ...
                square = canvas.create_oval(x, y, x + SPACE_SIZE, y + SPACE_SIZE, fill=HEAD, tag="snake")
            else:
                # Draw the body parts as squares
